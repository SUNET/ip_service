            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/model.ReplyIPInformation"
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiv1.CollisionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/apiv1.CollisionReply"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/model.StatusReply"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Success",
                        "schema": {
                            "$ref": "#/definitions/model.ReplyLookUp"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "model.ReplyIPInformation": {
            ...
            "properties": {
                ...
                "user_agent": {
                    "$ref": "#/definitions/useragent.UserAgent"
                }
            }
        },
        "model.ReplyLookUp": {
        ...
        "model.StatusReply": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/model.StatusReplyData"
                }
            }
        },
        "model.StatusReplyData": {
            "type": "object",
            "properties": {
                "build_variables": {
                    "$ref": "#/definitions/model.BuildVariables"
                },
                "probes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.StatusProbe"
                    }
                },
                "service_name": {
                    "type": "string"
        ...
        "rpsl.Object": {
            ...
            "properties": {
                ...
                "route-set": {
                    "description": "Route        []string ` + "`" + `json:\"route,omitempty\" bson:\"route,omitempty\"` + "`" + `\nRoute6       []string ` + "`" + `json:\"route6,omitempty\" bson:\"route6,omitempty\"` + "`" + `",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "useragent.UserAgent": {
            ...
            "properties": {
                ...
                "osversionNo": {
                    "$ref": "#/definitions/useragent.VersionNo"
                },
                "string": {
                    "type": "string"
                },
